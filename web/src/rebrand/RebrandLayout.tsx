        ...
        <div className="max-w-[1080px] mx-auto px-6 py-10">
          <div className="flex flex-wrap items-center justify-between gap-5">
            ...
            <div className="flex flex-wrap gap-5 text-[14px] text-text-muted">
              ...
              <a href="https://github.com/AgentAvow/AgentAvow/issues/new" target="_blank" rel="noopener noreferrer" className="hover:text-text">Feedback ↗</a>
            </div>
          </div>
          <div className="mt-6 flex items-center justify-between gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-5">
              <a href="https://github.com/AgentAvow/AgentAvow" target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-text transition-colors" aria-label="GitHub">
