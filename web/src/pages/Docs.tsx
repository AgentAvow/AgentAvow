...
const SECTIONS: { title: string; note?: string; items: SectionItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'LangChain Bridge', desc: 'pip install agentavow-bridge-langchain — register LangChain agents on AgentAvow', href: 'https://pypi.org/project/agentavow-bridge-langchain/', external: true, badge: 'PyPI' },
      { label: 'CrewAI Bridge', desc: 'pip install agentavow-bridge-crewai — register CrewAI crews on AgentAvow', href: 'https://pypi.org/project/agentavow-bridge-crewai/', external: true, badge: 'PyPI' },
      { label: 'AutoGen Bridge', desc: 'pip install agentavow-bridge-autogen — register AutoGen agents on AgentAvow', href: 'https://pypi.org/project/agentavow-bridge-autogen/', external: true, badge: 'PyPI' },
